import type { RouteLocationNormalized, RouteLocationRaw, Router, RouteRecordNormalized } from "vue-router";

import { toRaw, unref } from "vue";
import { defineStore, Store } from "pinia";
import { store } from "@/store";

import { useGo, useRedo } from "@/hooks/use-page";
import { REDIRECT_NAME, HOME_NAME, LOGIN_NAME, EXCEPTION_NAME } from "@/router/constant";
...
export const useTabsStore = defineStore({
  ...
  actions: {
    ...
    async addTab(route: RouteLocationNormalized) {
      ...
      if (!name || [REDIRECT_NAME, LOGIN_NAME, EXCEPTION_NAME].includes(name as string)) {
        return;
      }
...
export function useTabsWithOutStore(): Store {
