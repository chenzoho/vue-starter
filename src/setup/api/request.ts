...
class Request {
	...
	/**
	 *存放取消方法的集合
	 * @description 请求之前需要将url,push 到该集合中,封装一个方法，可以取消请求，传入 url: string|string[] 在请求之前判断同一URL是否存在，如果存在就取消请求
	 */
	cancelRequestSourceList?: CancelRequestSource[];

	/**
	 * 存放所有请求URL的集合
	 * @description 请求之前需要将url,push到该集合中,请求完毕后将url从集合中删除,添加在发送请求之前完成，删除在响应之后删除
	 */
